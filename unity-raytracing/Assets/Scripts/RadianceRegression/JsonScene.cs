            ...
            if (sharedMaterials.Count > 0)
            {
                ...
                for (int i = 0; i < sharedMaterials.Count; ++i)
                {
                    ...
                    else if (material.shader.name == "RayTracing/AreaLight")
                    {
                        ...
                        jsonMaterial.emission = new Vector3(material.GetFloat("_Intensity"), material.GetFloat("_Intensity"), material.GetFloat("_Intensity"));
            ...
            for (int i = 0; i < meshRenderers.Length; ++i)
            {
                ...
                if (lightComponent != null && lightComponent.type == LightType.Area)
                {
                    ...
                    if (lightMaterial != null && lightMaterial.shader.name == "RayTracing/AreaLight")
                    {
                        ...
                        Vector3 lightIntensity = new Vector3(lightMaterial.GetFloat("_Intensity"), lightMaterial.GetFloat("_Intensity"), lightMaterial.GetFloat("_Intensity"));
